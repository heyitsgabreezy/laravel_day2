    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li @if (request()->routeIs('movies.*')) class="active" @endif>
                    <a href="{{ route('movies.index') }}"><i class="fa fa-video-camera"></i> <span class="nav-label">Movies</span></a>
                </li>
                <li @if (request()->routeIs('books.*')) class="active" @endif>
                    <a href="{{ route('books.index') }}"><i class="fa fa-book"></i> <span class="nav-label">Books</span></a>
                </li>
                ...
                <li>
                    <a href="{{ route('pages.one') }}"><i class="fa fa-file"></i> <span class="nav-label">Page One</span></a>
                </li>
                <li>
                    <a href="{{ route('pages.two') }}"><i class="fa fa-file"></i> <span class="nav-label">Page Two</span></a>
                </li>
                <li>
                    <a href="{{ route('pages.three') }}"><i class="fa fa-file"></i> <span class="nav-label">Page Three</span></a>
                </li>
                <li>
                    <a href="{{ route('pages.four-helper') }}"><i class="fa fa-file"></i> <span class="nav-label">Page Four</span></a>
                </li>
...
<script>
    ...
    var pusher = new Pusher('e73bc3bd8961aa1366f5', {
      cluster: 'ap1'
    });
